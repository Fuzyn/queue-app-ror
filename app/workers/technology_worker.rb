...
class TechnologyWorker
  include ApplicationHelper

  ROUTING_KEY = 'qgame_app.technology_build'.freeze

  include Sneakers::Worker
  from_queue 'technology_build', exchange: 'qgame_app', exchange_type: :direct, routing_key: ROUTING_KEY
